...
ActiveRecord::Schema.define(version: 20151018010053) do
  ...
  create_table "name_interests", force: :cascade do |t|
  ...
  add_index "source_names", ["country", "name"], name: "index_source_names_on_country_and_name", using: :btree
